...
LOOP:	while (mIsCapturing) {
			...
			Buf buf = new Buf();
            encoderStatus = mMediaCodec.dequeueOutputBuffer(buf.mBufferInfo, TIMEOUT_USEC);
			MediaCodec.BufferInfo mBufferInfo = buf.mBufferInfo;
	...
	private ArrayList<Buf> bufList = new ArrayList<Buf>();
	class Buf{
		public Buf(){}
